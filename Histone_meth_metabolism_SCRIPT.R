...
promoter.peak.widths <- function(thistissue,
  ...
  promoter_widths <- lapply(tissue_chiptarget_gr_list, function(x){
    ...
    # duplications appear on both sides i.e. peaks that overlap multiple promoters, promoters that overlap multiple peaks.
    # from here on we will take a promoter view
    temppairs <- findOverlapPairs(x, tempprom)
    
    # calculate width of peaks
    peak_widths <- width(first(temppairs))
...
mycolourpallette <- alphabet(n = length(unique(pathway_df$pathway)))
...
#### HMT-NNNMT CORRELATIONS Fig 1D and Fig 1F ####
...
plot.selection.against.everything(everything_object = CCLE_allHMTs_with_everything,
...
NNMT_with_everything_TCGA <- rowMedians(NNMT_with_everything_TCGAfull)
...
#### plot PEMT expression vs reciprocal score - Fig 2L #### 
...
#### OTHER METHYLTRANSFERASE SETS for Fig S4 Fig S5 ####
...
ENCODE_NNMT_H3K4_genebody_model <- readRDS("output/ENCODE_NNMT_H3K4_genebody_model.rds")
ENCODE_NNMT_H3K9_genebody_model <- readRDS("output/ENCODE_NNMT_H3K9_genebody_model.rds")
ENCODE_NNMT_H3K27_genebody_model <- readRDS("output/ENCODE_NNMT_H3K27_genebody_model.rds")
ENCODE_NNMT_H3K36_genebody_model <- readRDS("output/ENCODE_NNMT_H3K36_genebody_model.rds")

ENCODE_NNMT_H3K4_promoter_model <- readRDS("output/ENCODE_NNMT_H3K4_promoter_model.rds")
ENCODE_NNMT_H3K9_promoter_model <- readRDS("output/ENCODE_NNMT_H3K9_promoter_model.rds")
ENCODE_NNMT_H3K27_promoter_model <- readRDS("output/ENCODE_NNMT_H3K27_promoter_model.rds")
ENCODE_NNMT_H3K36_promoter_model <- readRDS("output/ENCODE_NNMT_H3K36_promoter_model.rds")

ENCODE_NNMT_H3K9_repeats_model <- readRDS("output/ENCODE_NNMT_H3K9_repeats_model.rds")
...
#### ENCODE H3K4me3 WIDTH Fig S6A Fig S6B ####
...
#### correlate width measure to signal Fig S6A ####
...
#### NNMT / ChIP RELATIONSHIP TO EXPRESSION Fig S6D Fig S6E Fig S6F ####
...
NCI60_H3K4_promoters_signal_sites <- NCI60_H3K4_promoter_signal_sites[!(NCI60_H3K4_promoter_signal_sites %in% c("tissue")) & !str_detect(NCI60_H3K4_promoter_signal_sites, "MT")]
...
NCI60_H3K9_promoters_signal_sites <- NCI60_H3K9_promoter_signal_sites[!(NCI60_H3K9_promoter_signal_sites %in% c("tissue")) & !str_detect(NCI60_H3K9_promoter_signal_sites, "MT")]
...
NCI60_H4K20_promoters_signal_sites <- NCI60_H4K20_promoter_signal_sites[!(NCI60_H4K20_promoter_signal_sites %in% c("tissue")) & !str_detect(NCI60_H4K20_promoter_signal_sites, "MT")]
...
NCI60_RNAseq_plot_list <- list(genes = list(H3K4_NNMT = H3K4NNMTRNAseq_genes_signal_model[NCI60_H3K4_genes_signal_sites],
                                            ...
                                            H4K20_NNMT = H4K20NNMTRNAseq_genes_signal_model[NCI60_H4K20_genes_signal_sites],
                                            ...
                                            H3K9_NNMT = H3K9NNMTRNAseq_genes_signal_model[NCI60_H3K9_genes_signal_sites],
                               ...
                               promoters = list(H3K4_NNMT = H3K4NNMTRNAseq_promoters_signal_model[NCI60_H3K4_promoters_signal_sites],
                                                ...
                                                H4K20_NNMT = H4K20NNMTRNAseq_promoters_signal_model[NCI60_H4K20_promoters_signal_sites],
                                                ...
                                                H3K9_NNMT = H3K9NNMTRNAseq_promoters_signal_model[NCI60_H3K9_promoters_signal_sites],
...
colnames(RNAseq_plot_melt) <- c("signal", "gene", "group", "location")
...
NCI60mRNA_plot_list <- list(genes = list(H3K4_NNMT = H3K4NNMTmRNA_genes_signal_model[NCI60_H3K4_genes_signal_sites],
                                         H3K4_random = rowMeans(H3K4random_genes_signal_model[str_remove(row.names(H3K4random_genes_signal_model), "\\.t_value") %in% NCI60_H3K4_genes_signal_sites, ], na.rm = TRUE),
                                         H4K20_NNMT = H4K20NNMTmRNA_genes_signal_model[NCI60_H4K20_genes_signal_sites],
                                         H4K20_random = rowMeans(H4K20random_genes_signal_model[str_remove(row.names(H4K20random_genes_signal_model), "\\.t_value") %in% NCI60_H4K20_genes_signal_sites, ], na.rm = TRUE),
                                         H3K9_NNMT = H3K9NNMTmRNA_genes_signal_model[NCI60_H3K9_genes_signal_sites],
                                         H3K9_random = rowMeans(H3K9random_genes_signal_model[str_remove(row.names(H3K9random_genes_signal_model), "\\.t_value") %in% NCI60_H3K9_genes_signal_sites, ], na.rm = TRUE)),
                            promoters = list(H3K4_NNMT = H3K4NNMTmRNA_promoters_signal_model[NCI60_H3K4_promoters_signal_sites],
                                             H3K4_random = rowMeans(H3K4random_promoters_signal_model[str_remove(row.names(H3K4random_promoters_signal_model), "\\.t_value") %in% NCI60_H3K4_promoters_signal_sites, ], na.rm = TRUE),
                                             H4K20_NNMT = H4K20NNMTmRNA_promoters_signal_model[NCI60_H4K20_promoters_signal_sites],
                                             H4K20_random = rowMeans(H4K20random_promoters_signal_model[str_remove(row.names(H4K20random_promoters_signal_model), "\\.t_value") %in% NCI60_H4K20_promoters_signal_sites, ], na.rm = TRUE),
                                             H3K9_NNMT = H3K9NNMTmRNA_promoters_signal_model[NCI60_H3K9_promoters_signal_sites],
                                             H3K9_random = rowMeans(H3K9random_promoters_signal_model[str_remove(row.names(H3K9random_promoters_signal_model), "\\.t_value") %in% NCI60_H3K9_promoters_signal_sites, ], na.rm = TRUE)))           


mRNA_plot_melt <- melt(NCI60mRNA_plot_list)
colnames(mRNA_plot_melt) <- c("signal", "gene", "group", "location")
...
NCI60protein_plot_list <- list(genes = list(H3K4_NNMT = H3K4NNMTprotein_genes_signal_model[NCI60_H3K4_genes_signal_sites],
                                            H3K4_random = rowMeans(H3K4random_genes_signal_model[str_remove(row.names(H3K4random_genes_signal_model), "\\.t_value") %in% NCI60_H3K4_genes_signal_sites, ], na.rm = TRUE),
                                            H4K20_NNMT = H4K20NNMTprotein_genes_signal_model[NCI60_H4K20_genes_signal_sites],
                                            H4K20_random = rowMeans(H4K20random_genes_signal_model[str_remove(row.names(H4K20random_genes_signal_model), "\\.t_value") %in% NCI60_H4K20_genes_signal_sites, ], na.rm = TRUE),
                                            H3K9_NNMT = H3K9NNMTprotein_genes_signal_model[NCI60_H3K9_genes_signal_sites],
                                            H3K9_random = rowMeans(H3K9random_genes_signal_model[str_remove(row.names(H3K9random_genes_signal_model), "\\.t_value") %in% NCI60_H3K9_genes_signal_sites, ], na.rm = TRUE)),
                               promoters = list(H3K4_NNMT = H3K4NNMTprotein_promoters_signal_model[NCI60_H3K4_promoters_signal_sites],
                                                H3K4_random = rowMeans(H3K4random_promoters_signal_model[str_remove(row.names(H3K4random_promoters_signal_model), "\\.t_value") %in% NCI60_H3K4_promoters_signal_sites, ], na.rm = TRUE),
                                                H4K20_NNMT = H4K20NNMTprotein_promoters_signal_model[NCI60_H4K20_promoters_signal_sites],
                                                H4K20_random = rowMeans(H4K20random_promoters_signal_model[str_remove(row.names(H4K20random_promoters_signal_model), "\\.t_value") %in% NCI60_H4K20_promoters_signal_sites, ], na.rm = TRUE),
                                                H3K9_NNMT = H3K9NNMTprotein_promoters_signal_model[NCI60_H3K9_promoters_signal_sites],
                                                H3K9_random = rowMeans(H3K9random_promoters_signal_model[str_remove(row.names(H3K9random_promoters_signal_model), "\\.t_value") %in% NCI60_H3K9_promoters_signal_sites, ], na.rm = TRUE)))           

protein_plot_melt <- melt(NCI60protein_plot_list)
colnames(protein_plot_melt) <- c("signal", "gene", "group", "location")
...
NCI60_PEMT_RNAseq_plot_list <- list(genes = list(H3K4_PEMT = H3K4PEMTRNAseq_genes_signal_model[NCI60_H3K4_genes_signal_sites],
                                                 H3K4_random = rowMeans(H3K4random_genes_signal_model[str_remove(row.names(H3K4random_genes_signal_model), "\\.t_value") %in% NCI60_H3K4_genes_signal_sites, ], na.rm = TRUE),
                                                 H4K20_PEMT = H4K20PEMTRNAseq_genes_signal_model[NCI60_H4K20_genes_signal_sites],
                                                 H4K20_random = rowMeans(H4K20random_genes_signal_model[str_remove(row.names(H4K20random_genes_signal_model), "\\.t_value") %in% NCI60_H4K20_genes_signal_sites, ], na.rm = TRUE),
                                                 H3K9_PEMT = H3K9PEMTRNAseq_genes_signal_model[NCI60_H3K9_genes_signal_sites],
                                                 H3K9_random = rowMeans(H3K9random_genes_signal_model[str_remove(row.names(H3K9random_genes_signal_model), "\\.t_value") %in% NCI60_H3K9_genes_signal_sites, ], na.rm = TRUE)),
                                    promoters = list(H3K4_PEMT = H3K4PEMTRNAseq_promoters_signal_model[NCI60_H3K4_promoters_signal_sites],
                                                     H3K4_random = rowMeans(H3K4random_promoters_signal_model[str_remove(row.names(H3K4random_promoters_signal_model), "\\.t_value") %in% NCI60_H3K4_promoters_signal_sites, ], na.rm = TRUE),
                                                     H4K20_PEMT = H4K20PEMTRNAseq_promoters_signal_model[NCI60_H4K20_promoters_signal_sites],
                                                     H4K20_random = rowMeans(H4K20random_promoters_signal_model[str_remove(row.names(H4K20random_promoters_signal_model), "\\.t_value") %in% NCI60_H4K20_promoters_signal_sites, ], na.rm = TRUE),
                                                     H3K9_PEMT = H3K9PEMTRNAseq_promoters_signal_model[NCI60_H3K9_promoters_signal_sites],
                                                     H3K9_random = rowMeans(H3K9random_promoters_signal_model[str_remove(row.names(H3K9random_promoters_signal_model), "\\.t_value") %in% NCI60_H3K9_promoters_signal_sites, ], na.rm = TRUE)))           
...
#### REPETITIVE ELEMENTS IN THE NCI60 WITH BAYESIAN REMAPPING Fig 3D Fig S7D ####
...
#### comparison of relationship by signal Fig S7D Fig S7E ####
...
#### EXPRESSION FROM HERVs in NCI60 for Fig S6F and Fig S6G ####
...
#### CeNDR C. elegans data for Fig 5 and Fig S8 ####
...
Cel_HMTgenes <- getBM(mart = parasite_mart, 
               ...
               attributes = c("wormbase_gene", "wormbase_locus", "wormbase_gseq", "description"))
...
#### anmt and pmt expression versus HMTs no age correction; Fig S8B
...
#### age estimates with RAPToR for Fig S8C ####
...
#### heatmap of HMT residuals Fig S8A ####
...
#### INTRA-HMT CORRELATIONS HUMAN for Fig 4 ####
...
#### mean correlations with random genes for Fig 4B ####
...
#### HMT CORRELATION NETWORK PLOT PREPARATION for Fig 4C ####
...
#### LIN-35 ChIP in C. elegans Fig 5B ####
...
#### Retinoblastoma MUTANT CANCERS TCGA Fig 5D ####
...
#### is NNMT downstream of HMTs? Fig 5H ####
...
#### Rb mutants in the CCLE for Fig 5E ####
...
#### DOROTHEA AND TR ACTIVITY for Fig 5F ####
...
iterations_out <- sapply(1:100, function(i){
...
TCGA_median_TFcorrs <- rowMedians(iterations_out)
names(TCGA_median_TFcorrs) <- row.names(iterations_out)

TCGA_median_TFcorrs_df <- data.frame(TCGA_median_TFcorrs[order(TCGA_median_TFcorrs, decreasing = T)])
colnames(TCGA_median_TFcorrs_df) <- "Spearman_rho"

# E2F1 rank?
which(row.names(TCGA_median_TFcorrs_df) == "E2F1")

# Table S6

openxlsx::write.xlsx(list("correlations" = TCGA_HMTs_tissue_correlations,
                          "FDRs" = TCGA_HMTs_tissue_corr_FDRs,
                     "pancancer_correlations" = TCGA_median_TFcorrs_df),
                     "output/TCGA_HMTs_TRactivity_correlations.xlsx",
                     row.names = TRUE)
...
openxlsx::write.xlsx(list("correlations" = GTEX_HMTs_tissue_correlations,
                          "FDRs" = GTEX_HMTs_tissue_corr_FDRs,
                          "pantissue_correlations" = GTEX_median_TFcorrs_df),
                     "output/GTEX_HMTs_TRactivity_correlations.xlsx",
                     row.names = TRUE)

#### breast cancer scatterplot Fig 5F ####
...
#### E2F BINDING IN HUMAN HMTS Fig 5C ####
